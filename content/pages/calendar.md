...
<ul class="cal-list">
  ...
  <li class="cal-entry">
    <span class="cal-date">Sun Aug 2</span>
    <div class="cal-body">
      <div class="cal-title-row">
        <span class="cal-symbol">✎</span>
  ...
  <li class="cal-entry">
    <span class="cal-date">Thu Aug 6</span>
    <div class="cal-body">
      <div class="cal-title-row">
        <span class="cal-symbol">✎</span>
        <a class="cal-title" href="https://pools.events/event/T1TB7Vv2/shake-open-score/" target="_blank" rel="noopener" style="color: var(--text);">Shake + Open Score</a>
      </div>
      <div class="cal-meta">7pm &middot; Led by the Practice Space team</div>
    </div>
  </li>
