...
<h2 class="shop-heading" style="text-align: center; width: 100%; max-width: 672px;">Upcoming</h2>
...
<ul class="cal-list">
  ...
  <li class="cal-entry">
    ...
    <div class="cal-body">
      ...
      <div class="cal-meta">Three day workshop</div>
    </div>
  </li>
