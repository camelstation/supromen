...
<div class="events-section">
  ...
  <div class="event-block">
    ...
    <div class="event-text">
      <p>Tuesdays in May | Mondays in June | Performance Nite on July 6</p>
      ...
      <p>Single sessions are sliding scale $15-25. Get a bundle and save: all of May for $50-75, all of June for $60-85, or all sessions (including performance) for $100-200. Please pay what you can, and let us know (at <a href="mailto:practiceinspace@gmail.com">practiceinspace@gmail.com</a>) if cost is a barrier — no one will be turned away for lack of funds.</p>
      <p>WHEN &amp; WHO<br>
  ...
  <div class="event-block" id="meditation-sessions">
    ...
    <h3 class="event-title">Sunday Meditation Sessions</h3>
    <div class="event-text">
      <p>Artist Jemila MacEwan will host meditation sessions in the SUPR OMEN performance space on Sunday mornings from early May. These sessions will take a practical and creative approach to meditation. Each class will focus on a different aspect of diverse meditation practices and is ideal for anyone interested in learning different approaches to meditation, or who have had difficulty getting into meditation in the past. Meditation mats and cushions supplied. More details to come.</p>
    </div>
  </div>
</div>
...
<div class="events-section">
  ...
  <div class="event-block">
    ...
    <div class="event-text">
      <p>April 11 11-1pm | Body Wash is a 90 minute creative movement session hosted by Maya Rubio. This iteration is inspired by bugs – their unique movement qualities, sensorial experiences, and range of other characteristics. Drop in and find your bug dance!</p>
  ...
  <div class="event-block">
    ...
    <h3 class="event-title">Writing to Move, Moving to Write</h3>
    <div class="event-text">
      <p>March 1 6:30pm | A new workshop by C. Francis Fisher that uses movement to generate writing and writing to generate movement. The first meeting will take place Sunday March 1st from 6:30-8pm. For poets, dancers, novelists, movers of all kinds! There is no "level" required for participation. Come if you're looking to feel unstuck and develop rituals to create with freedom and fluency. Wear comfortable clothes and bring a notebook with writing utensils. Tickets are $15-25, sliding scale. To reserve your spot and for more information, <a href="http://withfriends.events/event/XkUeYreW/moving-to-write-writing-to-move/" target="_blank" rel="noopener">sign up here</a>.</p>
    </div>
  </div>
</div>
