...
<div class="pricing-section">
  ...
  <div class="pricing-text">
    <p>SUPR OMEN was founded to solve a persistent problem for performance artists: the need for a place to create experimental work and a place to be seen. We provide integrated studio and performance space in Bushwick, built around a community of artists, curators and mentors committed to experimentation. We exist to give emerging and mid-career artists the infrastructure, support, and creative permission to take real risks in their work and the connections to carry that work into the wider world.</p>
  </div>
</div>

<p class="about-closing">SUPR OMEN exists because New York City artists are amazing and contribute so much to the world.</p>
